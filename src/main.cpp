...
int main(int argc, char *argv1[]) {
    ...
    while (cli or (argc >= 1 and argv[0] != "exit")) {
        ...
        if (cli) {
            ...
            examples[3] = {"Naming conventions (class)", "clizard -ncc -b -i vbn/main.cpp vbn/NamingConvTests/Combined.cpp vbn/NamingConvTests/Combined.h"};
            examples[4] = {"Naming conventions (function)", "clizard -ncf -b -i vbn/main.cpp vbn/NamingConvTests/Combined.cpp vbn/NamingConvTests/Combined.h"};
            examples[5] = {"Naming conventions (variable)", "clizard -ncv -b -i vbn/main.cpp vbn/NamingConvTests/Combined.cpp vbn/NamingConvTests/Combined.h"};
